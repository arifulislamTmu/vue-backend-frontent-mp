                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="row">
                          ...
                          <div class="col-6 " v-if="form.new_photo">
                              <img :src="form.new_photo" alt="" id="image" style=" width: 80px; height: 60px; border:2px solid red; margin-bottom:2px;" />
                          </div>
                      </div>
                    </div>
                  </div>
...
onMounted(() => {
    ...
    .then((response)=>{
        ...
        form.shop_name = response.data.shop_name;
...
const onSelectedFile = (event) => {
    ...
    reader.onload = (event) => {
      form.new_photo = event.target.result;
    };

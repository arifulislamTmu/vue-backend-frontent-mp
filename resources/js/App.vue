<template>
    <div v-if="getToken != 0">
    <nav v-if="getToken != 0" class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <aside v-if="getToken != 0" class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="#" @click="logOut" class="nav-link" active-class="active">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Logout
                            </p>
    ...
    <aside v-if="getToken != 0" class="control-sidebar control-sidebar-dark">
    ...
    <footer v-if="getToken != 0"  class="main-footer">
